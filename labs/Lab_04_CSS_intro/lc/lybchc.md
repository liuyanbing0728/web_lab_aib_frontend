...
<body>
    ...
    <div>
        ...
        <h1>The Life of</h1>
        <h2>ITUshnik</h2>
        <img class="tupian" src="./4.webp" alt="Супер-пупер стильный код">
        <h3>2023 ZhangBiChen</h3>

    </div>

    <p>
        <a href="https://y.qq.com/n/ryqq/songDetail/002IUAKS0hutBn" ,style="target">Плейлист</a> для
        учёбы на чилле
    </p>
    <p>
